...
export default function InterviewConfigModal() {
  ...
  const [skills, setSkills] = useState("React, Next.js, JavaScript")
  const [difficulty, setDifficulty] = useState<(typeof difficultyLevels)[number]>("Medium")
  const [interviewType, setInterviewType] = useState<(typeof interviewTypes)[number]>("Mixed")
  const [questionCount, setQuestionCount] = useState(8)

  const estimatedTime = useMemo(() => questionCount * 2, [questionCount])
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="relative p-6 sm:p-8">
            ...
            <DialogFooter className="mt-6">
              ...
              <Button className="inline-flex items-center rounded-2xl bg-gradient-to-r from-sky-500 via-blue-600 to-violet-600 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-blue-500/20 hover:from-sky-400 hover:via-blue-500 hover:to-violet-500">
                Generate Questions
